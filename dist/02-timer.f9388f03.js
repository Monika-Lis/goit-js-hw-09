...
const options = {
    ...
    onClose (selectedDates) {
        ...
        if (selectedDates[0] <= currentDate) (0, _notiflixDefault.default).Notify.failure("Please choose a date in the future");
        else {
...
function startCountdown() {
    const intervalTime = setInterval(()=>{
        ...
        const readTime = convertMs(remainingTime);
...
},{"flatpickr":"llQu5","flatpickr/dist/flatpickr.min.css":"eVN6V","notiflix":"fuMq1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"eVN6V":[function() {},{}],"fuMq1":[function(require,module,exports) {
var global = arguments[3];
